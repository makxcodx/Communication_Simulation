...
public class Main {
    ...
    public static void main(String args[]) {
            ...
            for (int line_no = 1; line_no <= N; line_no++) {
                ...
                switch (operation_type) {
                    case 1: { // Input 1 : Creating a new Customer.
                        ...
                        System.out.print("Enter Limiting Amount: ");
                    ...
                    case 2: { // Input 2 : Creating a new Operator.
                        System.out.print("Enter TalkingCharge: ");
                        final double talkingCharge = reader.nextDouble();
                        System.out.print("Enter Message Cost: ");
                        final double messageCost = reader.nextDouble();
                        System.out.print("Enter Network Charge: ");
                    ...
                    case 3: { // Input 3 : A customer talks to another customer.
                        ...
                        if (first_cust_ID >= cust_cnt)
                            throw new NullPointerException("Invalid first customer ID in operation " + operation_type
                                    + ", line " + line_no + ".");
                        if (second_cust_ID >= cust_cnt)
                            throw new NullPointerException("Invalid second customer ID in operation " + operation_type
                                    + ", line " + line_no + ".");
                    ...
                    case 5: { // Input 5 : A customer connects to the Internet.
                        ...
                        if (cust_ID >= cust_cnt)
                            throw new NullPointerException(
                                    "Invalid customer ID in operation " + operation_type + ", line " + line_no + ".");
                    ...
                    case 8: { // Input 8 : A customer changes his/her Bill limit.
                        System.out.print("Enter Customer ID: ");
                        final int cust_ID = reader.nextInt();
                        System.out.print("Enter limitingAmount: ");
                        final double limitingAmount = reader.nextDouble();
        ...
        /*
         * 1) For each operator, print out, amount of time that they serviced for
         * talking,
         * number of messages sent via that operator, amount of Internet usage in terms
         * of MB that operator provided.
         * 
         * Operator <ID of the Operator> : <Talking Time> <Number of Messages> <MBs of
         * Internet Usage>
         */
        ...
        /*
         * 2) For each Customer, print out, how much money that they spend for paying
         * their bills
        ...
        /*
         * 3) Print out name of the Customer that talks the most and the amount of time
         * in terms of minutes.
         * 
        ...
        /*
         * 4) Print out name of the Customer that sends messages the most and the number
         * of messages.
         * 
